    ...
    def get(self, request):
        try:
            ...
            return custom_response(
                "Get all categories successfully!", "Success", serializer.data, 200
            )
        except:
...
class CategoryDetailAPIView(views.APIView):
    ...
    def get(self, request, id_slug, format=None):
        try:
            ...
            return custom_response(
                "Get category successfully!", "Success", serializer.data, 200
            )
        except:
            return custom_response(
                "Get category failed!", "Error", "Category not found!", 400
            )
    ...
    def put(self, request, id_slug):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return custom_response(
                    "Update category successfully!", "Success", serializer.data, 200
                )
            else:
                return custom_response(
                    "Update category failed", "Error", serializer.errors, 400
                )
        except:
            return custom_response(
                "Update category failed", "Error", "Category not found!", 400
            )
    ...
    def delete(self, request, id_slug):
        try:
            ...
            return custom_response(
                "Delete category failed!", "Error", "Category not found!", 400
            )
...
class ProductViewAPI(views.APIView):
    ...
    def post(self, request):
        try:
            ...
            return custom_response(
                "Create product successfully!", "Success", serializer.data, 201
            )
        except Exception as e:
            return custom_response(
                "Create product failed", "Error", {"error": str(e)}, 400
            )
...
class ProductDetailAPIView(views.APIView):
    ...
    def get(self, request, id_slug, format=None):
        try:
            ...
            return custom_response(
                "Get product failed!", "Error", "Product not found!", 400
            )
    ...
    def put(self, request, id_slug):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return custom_response(
                    "Update product successfully!", "Success", serializer.data, 200
                )
            else:
                return custom_response(
                    "Update product failed", "Error", serializer.errors, 400
                )
        except:
            return custom_response(
                "Update product failed", "Error", "Category not found!", 400
            )
    ...
    def delete(self, request, id_slug):
        try:
            ...
            product.delete()
            return custom_response(
                "Delete product successfully!", "Success", {"product_id": id_slug}, 204
            )
        except:
            return custom_response(
                "Delete product failed!", "Error", "Product not found!", 400
            )
...
class ProductImageAPIView(views.APIView):
    ...
    def get(self, request, product_id_slug):
        try:
            ...
            return custom_response(
                "Get all product images successfully!", "Success", serializers.data, 200
            )
        except:
            return custom_response(
                "Get all product images failed!",
                "Error",
    ...
    def post(self, request, product_id_slug):
        try:
            ...
            product_image = ProductImage(
                product_id=product, image_url=data["image_url"]
            )
            product_image.save()
            serializer = ProductImageSerializer(product_image)
            return custom_response(
                "Create product image successfully!", "Success", serializer.data, 201
            )
        except Exception as e:
            return custom_response(
                "Create product image failed", "Error", {"error": str(e)}, 400
            )
...
class ProductImageDetailAPIView(views.APIView):
    ...
    def get(self, request, product_id_slug, id_slug, format=None):
        try:
            ...
            serializer = ProductImageSerializer(product_image)
            return custom_response(
                "Get product image successfully!", "Success", serializer.data, 200
            )
        except:
            return custom_response(
                "Get product image failed!", "Error", "Product image not found!", 400
            )
    ...
    def put(self, request, product_id_slug, id_slug):
        try:
            ...
            if serializer.is_valid():
                ...
                return custom_response(
                    "Update product image failed", "Error", serializer.errors, 400
                )
        except:
            return custom_response(
                "Update product image failed", "Error", "Product image not found!", 400
            )
    ...
    def delete(self, request, product_id_slug, id_slug):
        try:
            ...
            return custom_response(
                ...
                "Success",
                {"product_image_id": id_slug},
                204,
            )
        except:
            return custom_response(
                "Delete product image failed!", "Error", "Product image not found!", 400
            )
...
class ProductCommentAPIView(views.APIView):
    ...
    def get(self, request, product_id_slug):
        try:
            ...
            return custom_response(
                "Get all product comments successfully!",
                "Success",
                serializers.data,
                200,
            )
            ...
            return custom_response(
                "Get all product comments failed!", "Error", None, 400
            )
    ...
    def post(self, request, product_id_slug):
        try:
            ...
            return custom_response(
                "Create product comment successfully!", "Success", serializer.data, 201
            )
        except Exception as e:
            return custom_response(
                "Create product comment failed", "Error", {"error": str(e)}, 400
            )
...
class ProductCommentDetailAPIView(views.APIView):
    ...
    def get(self, request, product_id_slug, id_slug, format=None):
        try:
            ...
            serializer = ProductCommentSerializer(product_comment)
            return custom_response(
                "Get product comment successfully!", "Success", serializer.data, 200
            )
        except:
            return custom_response(
                "Get product comment failed!",
                "Error",
    ...
    def put(self, request, product_id_slug, id_slug):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return custom_response(
                    "Update product comment successfully!",
                    "Success",
                    serializer.data,
                    200,
                )
                ...
                return custom_response(
                    "Update product comment failed", "Error", serializer.errors, 400
                )
        except:
            return custom_response(
                "Update product comment failed",
                "Error",
                "Product comment not found!",
                400,
            )
    ...
    def delete(self, request, product_id_slug, id_slug):
        try:
            ...
            return custom_response(
                "Delete product comment successfully!",
                "Success",
